...
from humaneva.datas import get_dct_matrix, reverse_dct_torch, dct_transform_torch
...
class Evaluate_FID_ACC_Humaneva():
    def __init__(self):
        ...
        self.cfg = ConfigDiverseSampling(exp_name="humaneva_t2", device="cuda:0", num_works=0)
        print("\n================== Configs =================")
