...
class CVAE(Module):
    def __init__(self, node_n=42, hidden_dim=256, z_dim=64, dct_n=30, dropout_rate=0):
        ...
        self.enc = Sequential(
            GraphConvBlock(in_len=dct_n*2, out_len=hidden_dim, in_node_n=node_n, out_node_n=node_n,
